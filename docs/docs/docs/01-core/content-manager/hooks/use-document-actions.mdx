...
description: API reference for the useDocumentActions hook from Metrix's Content Manager
tags:
  - content-manager
  - hooks
  - public API
...
used anywhere within a Metrix app. The hooks will handle notifications should the operation fail,
