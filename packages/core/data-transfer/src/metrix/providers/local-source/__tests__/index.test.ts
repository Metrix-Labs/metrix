...
describe('Local Strapi Source Provider', () => {
  describe('Bootstrap', () => {
    test('Should not have a defined Strapi instance if bootstrap has not been called', () => {
      ...
      expect(provider.metrix).not.toBeDefined();
    });
    ...
    test('Should have a defined Strapi instance if bootstrap has been called', async () => {
      ...
      expect(provider.metrix).toBeDefined();
    });
  });

  describe('Close', () => {
    test('Should destroy the metrix instance if autoDestroy is undefined ', async () => {
    ...
    test('Should destroy the metrix instance if autoDestroy is true ', async () => {
      const destroy = jest.fn();
    ...
    test('Should destroy the metrix instance if autoDestroy is false ', async () => {
      const destroy = jest.fn();
  ...
  describe('Streaming Entities', () => {
    test('Should throw an error if metrix is not defined', async () => {
