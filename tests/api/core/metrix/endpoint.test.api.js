...
describe('Create Strapi API End to End', () => {
  ...
  describe('Test oneToMany - manyToOne relation (article - category) with Content Manager', () => {
    ...
    afterAll(async () => {
      await modelsUtils.cleanupModels([form.article.uid, form.category.uid], { metrix });
    });
  ...
  describe('Test oneToOne relation (article - reference) with Content Manager', () => {
    ...
    afterAll(async () => {
      await modelsUtils.cleanupModels([form.article.uid, form.reference.uid], { metrix });
    });
  ...
  describe('Test oneWay relation (reference - tag) with Content Manager', () => {
    ...
    afterAll(async () => {
      await modelsUtils.cleanupModels([form.reference.uid, form.tag.uid], { metrix });
    });
