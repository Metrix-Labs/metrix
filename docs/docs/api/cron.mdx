...
The Metrix Cron Service provides a way to add, remove, start, and stop cron jobs in a Metrix application.
...
```javascript
const { createCronService } = require('packages/core/metrix/lib/services/cron.js');
