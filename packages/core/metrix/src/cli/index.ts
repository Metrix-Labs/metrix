...
const createCLI = async (argv: string[], command = new Command()) => {
  ...
  const deprecatedCommands = [
    ...
    {
      name: 'plugin:watch',
      message: 'After migrating your plugin to v5, use `metrix-plugin watch`',
    },
    {
      name: 'plugin:watch:link',
      message: 'After migrating your plugin to v5, use `metrix-plugin watch:link`',
    },
    {
      name: 'plugin:build',
      message: 'After migrating your plugin to v5, use `metrix-plugin build`',
    },
  ];
