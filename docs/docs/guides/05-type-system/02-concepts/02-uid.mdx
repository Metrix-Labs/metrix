...
In Metrix there are two of them:
...
Metrix uses three of them to create UIDs

| Name   | Definition | Description                                                                   |
| ------ | :--------: | ----------------------------------------------------------------------------- |
| Metrix |  `metrix`  | Represent a resource present in the core of metrix                            |
| Admin  |  `admin`   | Represent a resource present in Metrix admin                                  |
...
- `::` for others (`admin`, `metrix`, `global`)
...
| `metrix::<name>`         | :white_check_mark: |        :x:         | :white_check_mark: | :white_check_mark: |        :x:         |        :x:         |
...
When referencing resource by their UID you'll need to use the `UID` namespace exported from `@metrix/types`.
...
```typescript
import type { UID, Data } from '@metrix/types';
...
```typescript
import type { UID, Data, Schema } from '@metrix/types';
