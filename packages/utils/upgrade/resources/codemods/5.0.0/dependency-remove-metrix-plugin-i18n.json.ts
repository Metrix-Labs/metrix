...
/**
 * Specifically targets the root package.json and removes the @metrix/plugin-i18n dependency.
 *
 * Why? The i18n plugin is now a hard dependency of @metrix/metrix and isn't needed in the package.json anymore.
 */
