...
description: API reference for the useDragAndDrop hook in Metrix's Content Manager
tags:
  - content-manager
  - hooks
  - drag-and-drop
...
that you are somewhat familiar with `@metrix/design-system` components.
:::
...
```jsx
import { Box, Flex, IconButton } from '@metrix/design-system';
