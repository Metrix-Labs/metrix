import { useRBAC, useQueryParams } from '@metrixlabs/admin/strapi-admin';
...
import type { PanelComponent, PanelComponentProps } from '@metrixlabs/content-manager/strapi-admin';
