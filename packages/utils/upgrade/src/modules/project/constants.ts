...
export const PROJECT_PLUGIN_ROOT_FILES = ['metrix-admin.js', 'metrix-server.js'];
...
export const SCOPED_STRAPI_PACKAGE_PREFIX = '@metrixlabs/';

export const STRAPI_DEPENDENCY_NAME = `${SCOPED_STRAPI_PACKAGE_PREFIX}metrix`;
